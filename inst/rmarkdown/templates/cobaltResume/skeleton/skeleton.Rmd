...
```{r projects, echo=F}
create_resume_entry(title = "\\href{https://github.com/sebsciarra/cobaltResume}{cobaltResume}\\footnote{clickable hyperlink to the corresponding repository on my GitHub}", subtitle = "R Package", date = "May 2023", 
