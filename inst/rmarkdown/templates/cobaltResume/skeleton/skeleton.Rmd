...
```{r phd, echo=F}
generate_resume_entry(title = "PhD, Field", 
                 subtitle = "University", 
                 date = "Start Date--Completion Date", 
                 first_point = "Thesis title: \\textbf{This is my thesis title}", 
                 second_point = "General information about thesis",
                 #make sure to use detokenize if link contains special characters such as underscores (_)
                 third_point = "My thesis can be viewed 
                 #make \\href{\\detokenize{some_link}}{\\textcolor{blue}{here}}") 
```
...
generate_resume_entry(title = "Teaching Assistant", 
...
```{r cobalt-cv, echo=F}
generate_resume_entry(title = "\\href{https://github.com/sebsciarra/cobaltCV}{cobaltCV}\\footnote{clickable hyperlink to the corresponding repository on my GitHub}", subtitle = "R Package", date = "May 2023", 
...
generate_resume_entry(title = "\\href{sebastiansciarra.com}{sebastiansciarra.com}*", subtitle = "Personal website", date = "Mar. 2023", 
...
```{r guelphdown, echo=F}
generate_resume_entry(title = "\\href{https://github.com/sebsciarra/guelphdown}{guelphdown}*\\footnotetext{clickable hyperlink to the corresponding repository on my GitHub}", 
                 subtitle = "R Package", 
                 date = "Mar. 2023", 
...
generate_resume_entry(title = "\\href{https://github.com/sebsciarra/nonlinSimsAnalysis}{nonlinSimsAnalysis}*", 
                 subtitle = "R Package",
                 date = "March 2022", 
...
```{r nonlinSims, echo=F}
generate_resume_entry(title = "\\href{https://github.com/sebsciarra/nonlinSims}{nonlinSims}*", subtitle = "R Package", date = "Jan. 2022", 
...
generate_resume_entry(title = "\\href{https://github.com/sebsciarra/learning_SQL}{Learning SQL}*", subtitle = "Skill learning", date = "Mar. 2021", 
...
generate_resume_entry(title = "DataCamp courses", subtitle = "Skill learning", date = "June 2018--Aug. 2020", 
