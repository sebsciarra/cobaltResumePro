...
create_resume_entry(title = "PhD, Field", 
                 ...
                 third_point = "My thesis can be viewed \\href{\\detokenize{some_link}}{\\textcolor{blue}{here}}") 
```
...
```{r cobalt-cv, echo=F}
create_resume_entry(title = "\\href{https://github.com/sebsciarra/cobaltCV}{cobaltCV}\\footnote{clickable hyperlink to the corresponding repository on my GitHub}", subtitle = "R Package", date = "May 2023", 
