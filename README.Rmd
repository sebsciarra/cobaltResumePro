...
Résumés can be constructed by first creating an R Markdown file from the cobaltResume template.
...
```{r, echo=FALSE, out.width="25%", out.height="25%", fig.cap="Creating a résumé from the cobaltResume template."}
...
```{r, echo=FALSE, out.width="65%", out.height="65%", fig.cap="Creating a résumé from the cobaltResume template."}
