...
The goal of `cobaltResume` is to create professionally-looking résumés and cover letters. Here is a résumé I created for myself  `cobaltResume`: [my resume](man/resume_cover_letter.pdf). 
...
knitr::include_graphics("man/figures/resume_template.png")
```
...
```{r, echo=FALSE, out.width="50%", out.height="50%"}
knitr::include_graphics("man/figures/cover_letter.png")
```
